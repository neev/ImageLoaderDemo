...
import com.example.workdayimageloader.R
import kotlinx.android.synthetic.main.gif_item.view.*
import kotlinx.android.synthetic.main.message_item.view.*

class MessageFeedAdapter(val items: ArrayList<FeedDataItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class GifViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindMessage(message: GifItem) {
            ...
            itemView.gifViewAuthor.text = message.author.name
        }
    }
